...
t = time.time()
data_all_0413 = drag_analysis.analyze_experiment_set(folder_path,update=True,load_temperature=False)
elapsed = time.time() - t

print('Elapsed time: %.2f sec'%elapsed)
# %%
folder_path = 'C:/Users/Water Tunnel/Documents/GitHub/tunnel_control/_data/drag-data/2021-04-14'

t = time.time()
data_all_0414 = drag_analysis.analyze_experiment_set(folder_path,update=True,load_temperature=False)
elapsed = time.time() - t

print('Elapsed time: %.2f sec'%elapsed)
# %%
drag_analysis.plot_data(data_all_0413)
drag_analysis.plot_data(data_all_0414)
plt.title('All data in the parent directory')
# %%
folder_path = 'C:/Users/Water Tunnel/Documents/GitHub/tunnel_control/_data/drag-data/2021-04-15'

t = time.time()
data_all_0415 = drag_analysis.analyze_experiment_set(folder_path,update=True,load_temperature=False)
elapsed = time.time() - t

print('Elapsed time: %.2f sec'%elapsed)
# %%
drag_analysis.plot_data(data_all_0415)
# %%
drag_analysis.plot_data(data_all_0413)
drag_analysis.plot_data(data_all_0414)
plt.title('All data in the parent directory')
# %%
folder_path = 'C:/Users/Water Tunnel/Documents/GitHub/tunnel_control/_data/drag-data/2021-04-16'

t = time.time()
data_all_0416 = drag_analysis.analyze_experiment_set(folder_path,update=True,load_temperature=False)
elapsed = time.time() - t

print('Elapsed time: %.2f sec'%elapsed)
# %%
drag_analysis.plot_data(data_all_0416)
# drag_analysis.plot_data(data_all_0413)
# drag_analysis.plot_data(data_all_0414)
drag_analysis.plot_data(data_all_0415)
plt.title('All data in the parent directory')
...
# keys = [x for x in data_all.keys() if x.startswith('Flat') and 'Copy'  in x]
# drag_analysis.plot_selected(data_all,keys)

# keys = [x for x in data_all.keys() if x.startswith('2_1_1')]
# drag_analysis.plot_selected(data_all,keys)

# keys = [x for x in data_all.keys() if x.startswith('1_1_1')]
# drag_analysis.plot_selected(data_all,keys)
